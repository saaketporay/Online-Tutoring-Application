  ...
  return (
    <>
      <Box className="grid justify-items-center bg-[#191919]">
        <Typography variant="h3" className="mt-36 mb-5">Welcome to Online Tutoring Scheduler!</Typography>
        <Typography variant="h5" className="mb-20">We help students and instructors connect with each other.</Typography>
